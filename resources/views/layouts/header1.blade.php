    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__cart">
            <ul>
                <li>
                    ...
                    <a href="{{url('WishList')}}"><i class="fa fa-heart" style="color: #00b3b3;"></i> 
                ...
                <li>
                    <a href="{{route('cart.index')}}"><i class="fa fa-shopping-bag" style="color: #00b3b3;"></i> 
                        <span style="background-color: #cc6600;">
        ...
        <nav class="humberger__menu__nav mobile-menu">
            <ul>
                ...
                <li><a href="{{ url('requests') }}">Request Fabric</a></li>
                <!-- <li><a href="#">Pages</a>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__left">
                            <ul>
                                <li><i class="fa fa-envelope" style="color: #cc6600;"></i><a href="" style="color: white;"><strong>info@getfabrics.com</strong></a> </li>
